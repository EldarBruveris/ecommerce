    ...
    <div class="grid grid-cols-3 gap-4">
        @foreach ($goods as $good)    
            <div class="w-200 rounded-lg bg-gray-800 p-5 flex flex-col h-full">
                ...
                <a href="goods/{{ $good->id }}" class="inline-flex items-center px-3 py-2 mt-auto text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600">
                    Прочитать больше
